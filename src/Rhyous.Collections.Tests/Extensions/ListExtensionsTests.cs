...
namespace Rhyous.Collections.Tests
{
    ...
    public class ListExtensionsTests
    {
        ...
        public class ComplexA { public int Id { get; set; } public string Name { get; set; } }

        [TestMethod]
        public void ListExtensions_RemoveAny_ComplexObject_Test()
        {
            // Arrange
            var c1 = new ComplexA { Id = 1, Name = "C1" };
            var c2 = new ComplexA { Id = 2, Name = "C2" };
            var c3 = new ComplexA { Id = 3, Name = "C3" };
            IList<ComplexA> list = new List<ComplexA> { c1, c2, c3 };

            // Act
            list.RemoveAny(new[] { c2 });
