...
{
    /// <summary>Extension methods that apply to <see cref="T:IQueryable{T}"/>.</summary>
    public static class QueryableExtensions
    {
        ...
        /// <param name="queryable">The object to add this extension method to: <see cref="T:IQueryable{T}"/>.</param>
        /// <param name="take">the number to take. 0 or less does not include Take() to the queryable.</param>
        /// <returns>Returns queryable as is if take is 0 or less. Returns an <see cref="T:IQueryable{T}"/> with take added to it if take is greater than 0.</returns>
        ...
        /// <returns>Returns queryable as is if skip is 0 or less. Returns an <see cref="T:IQueryable{T}"/> with Skip added to it if skip is greater than 0.</returns>
